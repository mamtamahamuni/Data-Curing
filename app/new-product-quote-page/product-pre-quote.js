	...
	if(!angular.isUndefined($routeParams.lifeRefNo)){
		...
		ePQA.clickToPrefill = function(param){
			if(param == '1'){
				...
				//window.location.href =  'https://hpre.adityabirlahealth.com/buy-online-health-v2/activ-assure-pre-quote?lifeRefNo='+$routeParams.lifeRefNo+"&source="+$routeParams.source
			}else{
				window.location.href =  'https://hpre.adityabirlahealth.com/buy-online-health-v2/activ-assure-pre-quote'
			}
		}
