...
var partPaymentProcessingApp = angular.module("crfPaymentProcessingModule", []);

partPaymentProcessingApp.controller("cfr-payment-processing", ['ABHI_CONFIG', '$scope', '$rootScope', '$location', '$sessionStorage', 'RenewService', '$routeParams', '$timeout', function (ABHI_CONFIG, $scope, $rootScope, $location, $sessionStorage, RenewService, $routeParams, $timeout) {
    ...
    if(!sessionStorage.getItem('counterPgToken')){
    ...
    function userDropOff() {
        ...
        RenewService.postData(ABHI_CONFIG.apiUrl+"Renew/PageDrop", {
                    ...
                    "PageDrop": "cfr-payment-processing"
                },
                false
            )
            .then(function (data) {
    ...
    function fetchPgStatus() {
        ...
        RenewService.postData(ABHI_CONFIG.apiUrl+"CFRAcceptReject/PGStatus", {
                    "Token":  sessionStorage.getItem('counterPgToken')
                },
                false
            )
            .then(function (data) {
